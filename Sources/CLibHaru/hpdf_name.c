...
HPDF_STATUS
HPDF_Name_Write(HPDF_Name obj, HPDF_Stream stream) { return HPDF_Stream_WriteEscapeName(stream, obj->value); }
...
const char* HPDF_Name_GetValue(HPDF_Name obj) { return (const char*)obj->value; }
