...
HPDF_UINT HPDF_Image_GetWidth(HPDF_Image image) { return (HPDF_UINT)HPDF_Image_GetSize(image).x; }

HPDF_UINT HPDF_Image_GetHeight(HPDF_Image image) { return (HPDF_UINT)HPDF_Image_GetSize(image).y; }

HPDF_STATUS
HPDF_Image_SetMask(HPDF_Image image, HPDF_BOOL mask) {
...
HPDF_STATUS
HPDF_Image_SetColorSpace(HPDF_Image image, HPDF_Array colorspace) {
    if (!HPDF_Image_Validate(image))
        return HPDF_INVALID_IMAGE;
...
HPDF_STATUS
HPDF_Image_SetRenderingIntent(HPDF_Image image, const char* intent) {
    if (!HPDF_Image_Validate(image))
        return HPDF_INVALID_IMAGE;
