...
static void FreeWidth(HPDF_FontDef fontdef);
...
static HPDF_STATUS LoadFontData(HPDF_FontDef fontdef, HPDF_Stream stream);
...
static HPDF_STATUS LoadAfm(HPDF_FontDef fontdef, HPDF_Stream stream) {
    ...
    for (;;) {
        ...
        if (HPDF_StrCmp(keyword, "FontName") == 0) {
            HPDF_StrCpy(fontdef->base_font, s, fontdef->base_font + HPDF_LIMIT_MAX_NAME_LEN);
        } else
        ...
        } else if (HPDF_StrCmp(keyword, "FontBBox") == 0) {
        ...
        } else if (HPDF_StrCmp(keyword, "EncodingScheme") == 0) {
            HPDF_StrCpy(attr->encoding_scheme, s, attr->encoding_scheme + HPDF_LIMIT_MAX_NAME_LEN);
        } else if (HPDF_StrCmp(keyword, "CapHeight") == 0) {
            fontdef->cap_height = (HPDF_UINT16)HPDF_AToI(s);
        } else if (HPDF_StrCmp(keyword, "Ascender") == 0) {
            fontdef->ascent = (HPDF_INT16)HPDF_AToI(s);
        } else if (HPDF_StrCmp(keyword, "Descender") == 0) {
            fontdef->descent = (HPDF_INT16)HPDF_AToI(s);
        } else if (HPDF_StrCmp(keyword, "STDHW") == 0) {
            fontdef->stemh = (HPDF_UINT16)HPDF_AToI(s);
        } else if (HPDF_StrCmp(keyword, "STDHV") == 0) {
            fontdef->stemv = (HPDF_UINT16)HPDF_AToI(s);
        } else if (HPDF_StrCmp(keyword, "StartCharMetrics") == 0) {
            attr->widths_count = HPDF_AToI(s);
            break;
        }
    }

    cdata = (HPDF_CharData*)HPDF_GetMem(fontdef->mmgr, sizeof(HPDF_CharData) * attr->widths_count);
    if (cdata == NULL)
        return HPDF_Error_GetCode(fontdef->error);
...
HPDF_STATUS
HPDF_Type1FontDef_SetWidths(HPDF_FontDef fontdef, const HPDF_CharData* widths) {
...
HPDF_INT16
HPDF_Type1FontDef_GetWidthByName(HPDF_FontDef fontdef, const char* gryph_name) {
...
HPDF_INT16
HPDF_Type1FontDef_GetWidth(HPDF_FontDef fontdef, HPDF_UNICODE unicode) {
    HPDF_Type1FontDefAttr attr = (HPDF_Type1FontDefAttr)fontdef->attr;
