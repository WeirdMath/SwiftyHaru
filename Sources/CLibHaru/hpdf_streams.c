...
HPDF_STATUS
HPDF_MemStream_WriteFunc(HPDF_Stream stream, const HPDF_BYTE* ptr, HPDF_UINT siz);

HPDF_STATUS
HPDF_MemStream_SeekFunc(HPDF_Stream stream, HPDF_INT pos, HPDF_WhenceMode mode);

HPDF_STATUS
HPDF_MemStream_ReadFunc(HPDF_Stream stream, HPDF_BYTE* buf, HPDF_UINT* size);
...
HPDF_STATUS
HPDF_MemStream_InWrite(HPDF_Stream stream, const HPDF_BYTE** ptr, HPDF_UINT* count);

HPDF_STATUS
HPDF_Stream_WriteToStreamWithDeflate(HPDF_Stream src, HPDF_Stream dst, HPDF_Encrypt e);

HPDF_STATUS
HPDF_FileReader_ReadFunc(HPDF_Stream stream, HPDF_BYTE* ptr, HPDF_UINT* siz);

HPDF_STATUS
HPDF_FileReader_SeekFunc(HPDF_Stream stream, HPDF_INT pos, HPDF_WhenceMode mode);
...
HPDF_STATUS
HPDF_FileWriter_WriteFunc(HPDF_Stream stream, const HPDF_BYTE* ptr, HPDF_UINT siz);
...
HPDF_STATUS
HPDF_Stream_Read(HPDF_Stream stream, HPDF_BYTE* ptr, HPDF_UINT* size) {
    if (!(stream->read_fn))
 ...
 */
HPDF_STATUS
HPDF_Stream_Write(HPDF_Stream stream, const HPDF_BYTE* ptr, HPDF_UINT size) {
    HPDF_STATUS ret;
...
HPDF_STATUS
HPDF_Stream_WriteUInt(HPDF_Stream stream, HPDF_UINT value) { return HPDF_Stream_WriteInt(stream, (HPDF_INT)value); }
...
HPDF_STATUS
HPDF_Stream_Seek(HPDF_Stream stream, HPDF_INT pos, HPDF_WhenceMode mode) {
...
HPDF_FileStream_SizeFunc(HPDF_Stream stream) {
    ...
    if ((ptr = HPDF_FTELL(fp)) < 0) {
        HPDF_SetError(stream->error, HPDF_FILE_IO_ERROR, HPDF_FERROR(fp));
        return 0;
    }
...
HPDF_Stream HPDF_MemStream_New(HPDF_MMgr mmgr, HPDF_UINT buf_siz) {
    ...
    if (stream) {
        ...
        HPDF_MemStreamAttr attr = (HPDF_MemStreamAttr)HPDF_GetMem(mmgr, sizeof(HPDF_MemStreamAttr_Rec));
