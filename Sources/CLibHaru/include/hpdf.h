...
HPDF_STATUS
HPDF_ReadFromStream(HPDF_Doc pdf, HPDF_BYTE* buf, HPDF_UINT32* size);
...
HPDF_STATUS
HPDF_Destination_SetFitR(HPDF_Destination dst, HPDF_REAL left, HPDF_REAL bottom, HPDF_REAL right, HPDF_REAL top);
...
HPDF_STATUS
HPDF_FreeTextAnnot_SetLineEndingStyle(HPDF_Annotation annot,
...
/*----- 3D Measure ---------------------------------------------------------*/
HPDF_3DMeasure
    HPDF_Page_Create3DC3DMeasure(HPDF_Page page, HPDF_Point3D firstanchorpoint, HPDF_Point3D textanchorpoint);
...
HPDF_STATUS
HPDF_SetInfoAttr(HPDF_Doc pdf, HPDF_InfoType type, const char* value);
...
/* cm */
HPDF_STATUS
HPDF_Page_Concat(HPDF_Page page, HPDF_REAL a, HPDF_REAL b, HPDF_REAL c, HPDF_REAL d, HPDF_REAL x, HPDF_REAL y);
...
/* rg */
HPDF_STATUS
HPDF_Page_SetRGBFill(HPDF_Page page, HPDF_REAL r, HPDF_REAL g, HPDF_REAL b);
...
HPDF_STATUS
HPDF_Page_DrawImage(HPDF_Page page, HPDF_Image image, HPDF_REAL x, HPDF_REAL y, HPDF_REAL width, HPDF_REAL height);

HPDF_STATUS
HPDF_Page_Circle(HPDF_Page page, HPDF_REAL x, HPDF_REAL y, HPDF_REAL ray);
...
HPDF_STATUS
HPDF_Page_SetSlideShow(HPDF_Page page, HPDF_TransitionStyle type, HPDF_REAL disp_time, HPDF_REAL trans_time);
