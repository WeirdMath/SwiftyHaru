...
typedef char* (*HPDF_Encoder_EncodeText_Func)(HPDF_Encoder encoder,
                                              const char* text,
                                              HPDF_UINT len,
...
HPDF_UNICODE
HPDF_Encoder_ToUnicode(HPDF_Encoder encoder, HPDF_UINT16 code);
...
HPDF_STATUS
HPDF_CMapEncoder_SetParseText(HPDF_Encoder encoder, HPDF_ParseText_Rec* state, const HPDF_BYTE* text, HPDF_UINT len);
