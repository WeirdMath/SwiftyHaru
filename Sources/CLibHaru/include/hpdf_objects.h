...
HPDF_STATUS
HPDF_Obj_WriteValue(void* obj, HPDF_Stream stream, HPDF_Encrypt e);

HPDF_STATUS
HPDF_Obj_Write(void* obj, HPDF_Stream stream, HPDF_Encrypt e);
...
HPDF_STATUS
HPDF_Boolean_Write(HPDF_Boolean obj, HPDF_Stream stream);
...
HPDF_STATUS
HPDF_Number_Write(HPDF_Number obj, HPDF_Stream stream);
...
HPDF_STATUS
HPDF_Real_Write(HPDF_Real obj, HPDF_Stream stream);
...
HPDF_STATUS
HPDF_Name_Write(HPDF_Name obj, HPDF_Stream stream);
...
HPDF_STATUS
HPDF_String_SetValue(HPDF_String obj, const char* value);

void HPDF_String_Free(HPDF_String obj);

HPDF_STATUS
HPDF_String_Write(HPDF_String obj, HPDF_Stream stream, HPDF_Encrypt e);

HPDF_INT32
HPDF_String_Cmp(HPDF_String s1, HPDF_String s2);
...
HPDF_STATUS
HPDF_Binary_SetValue(HPDF_Binary obj, HPDF_BYTE* value, HPDF_UINT len);
...
HPDF_STATUS
HPDF_Binary_Write(HPDF_Binary obj, HPDF_Stream stream, HPDF_Encrypt e);
...
HPDF_STATUS
HPDF_Array_Write(HPDF_Array array, HPDF_Stream stream, HPDF_Encrypt e);

HPDF_STATUS
HPDF_Array_Add(HPDF_Array array, void* obj);

HPDF_STATUS
HPDF_Array_Insert(HPDF_Array array, void* target, void* obj);

void* HPDF_Array_GetItem(HPDF_Array array, HPDF_UINT index, HPDF_UINT16 obj_class);

HPDF_STATUS
HPDF_Array_AddNumber(HPDF_Array array, HPDF_INT32 value);

HPDF_STATUS
HPDF_Array_AddReal(HPDF_Array array, HPDF_REAL value);

HPDF_STATUS
HPDF_Array_AddName(HPDF_Array array, const char* value);
...
HPDF_STATUS
HPDF_Dict_Write(HPDF_Dict dict, HPDF_Stream stream, HPDF_Encrypt e);

const char* HPDF_Dict_GetKeyByObj(HPDF_Dict dict, void* obj);

HPDF_STATUS
HPDF_Dict_Add(HPDF_Dict dict, const char* key, void* obj);

void* HPDF_Dict_GetItem(HPDF_Dict dict, const char* key, HPDF_UINT16 obj_class);

HPDF_STATUS
HPDF_Dict_AddName(HPDF_Dict dict, const char* key, const char* value);

HPDF_STATUS
HPDF_Dict_AddNumber(HPDF_Dict dict, const char* key, HPDF_INT32 value);

HPDF_STATUS
HPDF_Dict_AddReal(HPDF_Dict dict, const char* key, HPDF_REAL value);

HPDF_STATUS
HPDF_Dict_AddBoolean(HPDF_Dict dict, const char* key, HPDF_BOOL value);

HPDF_STATUS
HPDF_Dict_RemoveElement(HPDF_Dict dict, const char* key);
...
HPDF_STATUS
HPDF_Xref_Add(HPDF_Xref xref, void* obj);

HPDF_XrefEntry HPDF_Xref_GetEntry(HPDF_Xref xref, HPDF_UINT index);

HPDF_STATUS
HPDF_Xref_WriteToStream(HPDF_Xref xref, HPDF_Stream stream, HPDF_Encrypt e);
