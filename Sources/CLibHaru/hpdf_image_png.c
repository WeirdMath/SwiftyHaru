...
static void PngReadFunc(png_structp png_ptr, png_bytep data, png_uint_32 length) {
...
static HPDF_STATUS ReadPngData_Interlaced(HPDF_Dict image, png_structp png_ptr, png_infop info_ptr) {
    ...
    png_bytep* row_pointers = HPDF_GetMem(image->mmgr, height * sizeof(png_bytep));
...
static HPDF_STATUS ReadTransparentPaletteData(HPDF_Dict image,
                                              png_structp png_ptr,
                                              png_infop info_ptr,
...
static HPDF_STATUS
    ReadTransparentPngData(HPDF_Dict image, png_structp png_ptr, png_infop info_ptr, png_bytep smask_data) {
    HPDF_STATUS ret = HPDF_OK;
    HPDF_INT row_len;
    HPDF_UINT i, j;
