...
HPDF_STATUS
HPDF_Number_Write(HPDF_Number obj, HPDF_Stream stream) { return HPDF_Stream_WriteInt(stream, obj->value); }

void HPDF_Number_SetValue(HPDF_Number obj, HPDF_INT32 value) { obj->value = value; }
