...
static const HPDF_CidRange_Rec UTF8_CID_RANGE[] = {{0x0000, 0xFFFF, 0x0}, {0xFFFF, 0xFFFF, 0x0}};
...
static HPDF_UNICODE UTF8_Encoder_ToUnicode_Func(HPDF_Encoder encoder, HPDF_UINT16 code) {
    ...
    case 3:
        val =
            (unsigned int)((utf8_attr->utf8_bytes[0] & 0x7) << 18) + (unsigned int)((utf8_attr->utf8_bytes[1]) << 12) +
            (unsigned int)((utf8_attr->utf8_bytes[2] & 0x3f) << 6) + (unsigned int)((utf8_attr->utf8_bytes[3] & 0x3f));
        break;
    case 2:
    ...
    case 1:
        val =
            (unsigned int)((utf8_attr->utf8_bytes[0] & 0x1f) << 6) + (unsigned int)((utf8_attr->utf8_bytes[1] & 0x3f));
        break;
    case 0:
