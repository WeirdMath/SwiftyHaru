...
static HPDF_STATUS AddChild(HPDF_Outline parent, HPDF_Outline item);

static HPDF_STATUS BeforeWrite(HPDF_Dict obj);

static HPDF_UINT CountChild(HPDF_Outline outline);
...
static HPDF_STATUS AddChild(HPDF_Outline parent, HPDF_Outline item) {
    HPDF_Outline first = (HPDF_Outline)HPDF_Dict_GetItem(parent, "First", HPDF_OCLASS_DICT);
    HPDF_Outline last = (HPDF_Outline)HPDF_Dict_GetItem(parent, "Last", HPDF_OCLASS_DICT);
    HPDF_STATUS ret = 0;
...
HPDF_Outline_GetOpened(HPDF_Outline outline) {
    HPDF_Number n = (HPDF_Number)HPDF_Dict_GetItem(outline, "_OPENED", HPDF_OCLASS_NUMBER);
...
HPDF_Outline HPDF_Outline_GetFirst(HPDF_Outline outline) {
    ...
    return (HPDF_Outline)HPDF_Dict_GetItem(outline, "First", HPDF_OCLASS_DICT);
}
...
HPDF_Outline HPDF_Outline_GetParent(HPDF_Outline outline) {
    ...
    return (HPDF_Outline)HPDF_Dict_GetItem(outline, "Parent", HPDF_OCLASS_DICT);
}

static HPDF_STATUS BeforeWrite(HPDF_Dict obj) {
    HPDF_Number n = (HPDF_Number)HPDF_Dict_GetItem(obj, "Count", HPDF_OCLASS_NUMBER);
...
HPDF_Outline_Validate(HPDF_Outline outline) {
    ...
    if (outline->header.obj_class != (HPDF_OSUBCLASS_OUTLINE | HPDF_OCLASS_DICT))
        return HPDF_FALSE;
...
HPDF_STATUS HPDF_Outline_SetOpened(HPDF_Outline outline, HPDF_BOOL opened) {
    ...
    n = (HPDF_Number)HPDF_Dict_GetItem(outline, "_OPENED", HPDF_OCLASS_NUMBER);
