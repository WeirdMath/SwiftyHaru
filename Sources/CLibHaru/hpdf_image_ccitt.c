 ...
 */
static int
    HPDF_Fax3SetupState(struct _HPDF_CCITT_Data* pData, HPDF_UINT width, HPDF_UINT height, HPDF_UINT line_width) {
...
static /*inline*/ int32 find1span(unsigned char* bp, int32 bs, int32 be) {
    int32 bits = be - bs;
    int32 n, span;
 ...
 */
static HPDF_STATUS HPDF_Fax4Encode(struct _HPDF_CCITT_Data* pData, tidata_t bp, tsize_t cc /*, tsample_t s*/) {
    HPDF_Fax3CodecState* sp = EncoderState(pData);
