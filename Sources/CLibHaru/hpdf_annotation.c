...
static const char* const HPDF_ANNOT_TYPE_NAMES[] = {"Text",
                                                    "Link",
                                                    "Sound",
                                                    "FreeText",
                                                    "Stamp",
...
static const char* const HPDF_ANNOT_INTENT_NAMES[] = {"FreeTextCallout",
                                                      "FreeTextTypeWriter",
                                                      "LineArrow",
                                                      "LineDimension",
                                                      "PolygonCloud",
...
static const char* const HPDF_LINE_ANNOT_ENDING_STYLE_NAMES[] =
    {"None", "Square", "Circle", "Diamond", "OpenArrow", "ClosedArrow", "Butt", "ROpenArrow", "RClosedArrow", "Slash"};

static const char* const HPDF_LINE_ANNOT_CAP_POSITION_NAMES[] = {"Inline", "Top"};

static const char* const HPDF_STAMP_ANNOT_NAME_NAMES[] = {"Approved",
                                                          "Experimental",
                                                          "NotApproved",
                                                          "AsIs",
                                                          "Expired",
...
HPDF_Annotation HPDF_3DAnnot_New(HPDF_MMgr mmgr, HPDF_Xref xref, HPDF_Rect rect, HPDF_U3D u3d) {
    HPDF_Annotation annot;
...
HPDF_STATUS HPDF_3DAnnot_Set3DView(HPDF_Annotation annot) {
    HPDF_Boolean b;
...
HPDF_Annotation
    HPDF_ProjectionAnnot_New(HPDF_MMgr mmgr, HPDF_Xref xref, HPDF_Rect rect, const char* text, HPDF_Encoder encoder) {
    HPDF_Annotation annot;
    HPDF_String s;
    HPDF_PTRACE((" HPDF_StampAnnot_New\n"));
...
HPDF_STATUS HPDF_TextMarkupAnnot_SetQuadPoints(HPDF_Annotation annot,
                                               ...
                                               HPDF_Point rb,
                                               HPDF_Point lt,
                                               HPDF_Point rt) /* l-left, r-right, b-bottom, t-top positions */
{
...
HPDF_STATUS HPDF_MarkupAnnot_SetRectDiff(
    HPDF_Annotation annot,
    HPDF_Rect rect) /* RD entry : this is the difference between Rect and the text annotation rectangle */
{
    HPDF_Array array;
    HPDF_STATUS ret = HPDF_OK;
    HPDF_REAL tmp;
