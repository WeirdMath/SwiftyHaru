 ...
 */
    ...
    func constructRect(in context: DrawingContext,
        ...
        context.show(text: label, atPosition: Point(x: x, y: y - 10))
        return Path()
            .appendingRectangle(x: x, y: y - 40, width: 220, height: 25)
    }
/*: 
 ...
 */
    page.draw { context in
        ...
        context.show(text: "LineJoin.miter",
                     atPosition: Point(x: 60, y: 360))
        ...
        context.show(text: "LineJoin.round",
                     atPosition: Point(x: 60, y: 255))
        ...
        context.show(text: "LineJoin.bevel",
                     atPosition: Point(x: 60, y: 150))
    }
/*:
 ...
 */
    page.draw { context in
        ...
        let strokeRectangle = constructRect(in: context,
                                            x: 300,
                                            y: 770,
                                            label: "Stroke")
        context.stroke(strokeRectangle)

        let fillRectangle = constructRect(in: context,
                                          x: 300,
                                          y: 720,
                                          label: "Fill")
        context.fill(fillRectangle)

        let fillStrokeRectangle = constructRect(in: context,
                                                x: 300,
                                                y: 670,
 ...
 */
    page.draw { context in
        ...
        let clipRectangle = constructRect(in: context,
                                          x: 300,
                                          y: 620,
